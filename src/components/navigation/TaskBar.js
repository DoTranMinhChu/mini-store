        ...
        return (
            <nav className="taskbar-box">
                <div className="taskbar-box__container">
                    ...
                    <NavLink to="mini-store" end className={(navData) => "task-bar-item " + (navData.isActive ? "task-bar-item--active" : "")} >
                        <FontAwesomeIcon className="task-bar-item__icon" icon={faHome} />
                        <h1 className="task-bar-item__title">Home</h1>
                    </NavLink>


                    <NavLink to="mini-store/cart" end className={(navData) => "task-bar-item " + (navData.isActive ? "task-bar-item--active" : "")} >
                        <FontAwesomeIcon className="task-bar-item__icon" icon={faCartShopping} />
                        <h1 className="task-bar-item__title">Cart</h1>
                    </NavLink>

                    <NavLink to="mini-store/info" end id="nav-Info" className={(navData) => "task-bar-item " + (navData.isActive ? "task-bar-item--active" : "")} >
